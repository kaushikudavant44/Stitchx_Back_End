package com.mavericksoft.stitchx.security.jwt;
...
public class JwtUtils {
	...
	@Value("${stitchx.app.jwtSecret}")
	private String jwtSecret;

	@Value("${stitchx.app.jwtExpirationMs}")
	private int jwtExpirationMs;

	@Value("${stitchx.app.jwtCookieName}")
	...
	public String refreshToken(String bearerToken) {
		String token = removeBearerKeyword(bearerToken);
